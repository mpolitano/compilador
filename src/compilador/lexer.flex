...
<YYINITIAL> {
    ...
    "externinvk" { return symbol(sym.EXTERNINVK);  System.out.println (yytext());}
    ...
    //Tipos
    "int" { return symbol(sym.RESERV_INT);  System.out.println (yytext());}
    "float" { return symbol(sym.RESERV_FLOAT);  System.out.println (yytext());}
    "boolean" { return symbol(sym.RESERV_BOOLEAN);  System.out.println (yytext());}
